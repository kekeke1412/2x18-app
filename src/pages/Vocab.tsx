...
import { useVocab, useMembers, useUserVocab, useQuizHistory } from '../hooks/useDomainQueries';
...
export default function Vocab() {
  const { currentUser, isSuperAdmin, isCore, addVocabSet, deleteVocabSet } = useApp();
